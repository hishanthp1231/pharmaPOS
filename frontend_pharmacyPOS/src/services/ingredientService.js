...
// Get ingredients for current branch
export const getIngredients = async (branchId) => {
  const id = branchId || localStorage.getItem('branch_id') || '1';
  const res = await api.get('/ingredients', { params: { branch_id: id } });
